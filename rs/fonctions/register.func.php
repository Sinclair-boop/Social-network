<?php
 ...
 function inscrire_utilisateur($pseudo,$password,$email,$sexe,$situation,$apropos){
 	...
 	global $db;
 	$inscrire=$db->prepare("INSERT INTO utilisateurs (id,pseudo,password,email,sexe,situation,apropos,avatar) VALUES (?,?,?,?,?,?,?,?)");
 	$inscrire->execute(array('',$pseudo,$password,$email,$sexe,$situation,$apropos,'defaut.jpg'));
